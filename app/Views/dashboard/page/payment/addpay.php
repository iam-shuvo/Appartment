...
<?= $this->section('content') ;?>
    ...
    <div class="col-8 m-3">
            ...
            <div class="d-flex justify-content-between my-4"> <h3><?= $page_heading; ?></h3><a href="<?= base_url()?>dashboard/all_pay" class="text-decoration-none btn btn-primary ">All new</a>
</div>
        <div class="mb-3">
                    <label for="tanent_name" class="form-label">Tanent Name</label>
                    <input type="text" class="form-control" id="tanent_name" name="tanent_name">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="paymeth" name="paymeth">
