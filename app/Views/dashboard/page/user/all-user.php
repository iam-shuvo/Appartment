                ...
                <tr class="align-middle">
                    ...
                    <td>
                        <ul class="d-flex list-unstyled m-0"> 
                            <li><a class="edit" href="<?= base_url('dashboard/edit_use/'.$user['user_id'] ) ?>"><i class="fa-solid fa-eye p-1"></a></i></li>
                            <li><a href="<?= base_url('dashboard/edit_user/'.$user['user_id'] ) ?>"><i class="fa-regular fa-pen-to-square p-1"></i></a></li>
                            <li><a href="<?= base_url('dashboard/delete_user/'.$user['user_id'] ) ?>"><i class="fa-solid fa-trash p-1"></i></li></a>
                        </ul>
                    </td>
                </tr>
                <?php
